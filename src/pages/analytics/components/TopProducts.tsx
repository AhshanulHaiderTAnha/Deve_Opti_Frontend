...
export default function TopProducts({ products = [] }: { products?: ProductItem[] }) {
              ...
              <tr key={i} className="group hover:bg-gray-50/50 dark:hover:bg-gray-900/50 transition-colors">
                ...
                <td className="py-4">
                  <div className={`inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold ${
                    product.platform === 'Amazon' ? 'bg-orange-50 text-orange-600 border border-orange-100 dark:bg-orange-500/10 dark:border-orange-500/20' :
