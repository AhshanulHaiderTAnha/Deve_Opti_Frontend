        ...
        if (res.status === 'success') {
          const mapped = res.data.map((tier: any, index: number) => {
            ...
            return {
              ...
              balanceRange: tier.max_amount ? `$${Number(tier.min_amount).toLocaleString()} - $${Number(tier.max_amount).toLocaleString()}` : `Above $${Number(tier.min_amount).toLocaleString()}`,
              color: style.color,
              bgColor: style.bg,
            ...
            tiers.map((tier, index) => (
              ...
              >
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-sm text-gray-500 font-bold uppercase tracking-wider">Commission Per Order</p>
                </div>
                ...
                <div className="text-center pt-4 border-t-2 border-gray-100">
                  <p className="text-xs text-gray-500 mb-1 font-medium">Daily Potential (4 batches × 25 orders)</p>
