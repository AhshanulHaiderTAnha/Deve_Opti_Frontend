...
const LoadingState = () => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-white dark:bg-gray-900 transition-colors duration-500">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-blue-500/5 rounded-full blur-[100px] animate-pulse delay-700"></div>

      <div className="relative flex flex-col items-center">
        {/* Logo Container with Animation */}
        <div className="relative mb-8 group">
          <div className="absolute inset-0 bg-emerald-500/20 rounded-full blur-2xl scale-125 animate-pulse"></div>
        ...
        <div className="text-center">
          <h2 className="text-2xl md:text-3xl font-black bg-gradient-to-r from-emerald-600 to-blue-600 bg-clip-text text-transparent mb-2">
      ...
      <div className="absolute bottom-12 w-48 h-1.5 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden border border-gray-50 dark:border-gray-700">
        <div className="absolute top-0 left-0 h-full w-1/3 bg-gradient-to-r from-emerald-500 to-blue-500 rounded-full animate-progress-slide"></div>
      </div>
